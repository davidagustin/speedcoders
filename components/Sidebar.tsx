...
export function Sidebar({ user }: SidebarProps) {
	...
	return (
		<div
			className={`hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:z-50 lg:bg-white dark:bg-slate-900 lg:border-r lg:border-gray-200 dark:border-slate-700 transition-all duration-300 ${
