...
import type { SkillLevel, UserProgress } from "@/lib/ProgressTracker";
...
export function ProgressDashboard({
	...
	const [selectedTab, setSelectedTab] = useState<
		"overview" | "skills" | "achievements" | "activity"
	>("overview");
						...
						{difficultyStats.map((difficulty) => (
							<div key={difficulty.name} className="flex items-center">
								<div className="flex-1 flex items-center">
									<div
										className={`w-3 h-3 rounded-full ${difficulty.color} mr-3`}
									/>
						...
						<div className="flex items-start">
							...
							<div className="flex-1">
								<div className="flex items-center gap-2 mb-2">
									...
									<span
										className={`text-xs px-2 py-1 rounded ${rarityColors[achievement.rarity as keyof typeof rarityColors]}`}
									>
										{achievement.rarity}
									</span>
								</div>
