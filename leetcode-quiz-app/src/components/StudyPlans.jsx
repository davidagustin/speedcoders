...
import { allLeetcodeProblems, algorithmCategories, companyTags } from '../data/allProblems';
...
function StudyPlans({ user }) {
  ...
  const studyPlans = {
    'faang-prep': {
      ...
      problemsPerDay: 3,
      totalProblems: 180,
      categories: ['Array', 'Dynamic Programming', 'Tree', 'Graph', 'System Design'],
    ...
    'algorithm-mastery': {
      ...
      problemsPerDay: 2,
      totalProblems: 180,
      categories: ['Array', 'Hash Table', 'Two Pointers', 'Sliding Window', 'Binary Search'],
      companies: [],
      schedule: [
    ...
    'data-structures': {
      ...
      problemsPerDay: 2,
      totalProblems: 90,
      categories: ['Stack', 'Queue', 'Heap', 'Trie', 'Union Find', 'Segment Tree'],
      companies: [],
      schedule: [
    ...
    'competitive-programming': {
      ...
      problemsPerDay: 1,
      totalProblems: 120,
      categories: ['Graph', 'Dynamic Programming', 'Math', 'Greedy', 'Binary Search'],
      companies: [],
      schedule: [
  ...
  const getUserProgress = (planId) => {
    ...
    if (!currentUser?.studyPlans) return { started: false, progress: 0, streak: 0 };
  ...
  const createCustomStudyPlan = () => {
    ...
    const newPlan = {
      ...
      schedule: [
        { week: `1-${Math.ceil(customPlan.duration / 7)}`, focus: 'Custom Practice', problems: totalProblems }
      ],
      isCustom: true
    };
    ...
    if (userIndex !== -1) {
      if (!users[userIndex].customStudyPlans) users[userIndex].customStudyPlans = {};
  ...
  const PlanCard = ({ planId, plan, isCustom = false }) => {
    ...
    const progressPercentage = plan.totalProblems > 0 
      ...
      <div className="study-plan-card">
            ...
            <div className="schedule-list">
              {plan.schedule.map((phase, index) => (
                <div key={index} className="schedule-item">
                  ...
                  <div className="schedule-problems">{phase.problems} problems</div>
                </div>
              ))}
            </div>
        ...
        <div className="plan-actions">
          <button 
            ...
            onClick={() => setSelectedPlan(selectedPlan === planId ? null : planId)}
          >
  ...
  return (
    <div className="study-plans">
      ...
      {/* User's Active Plans */}
      {Object.entries(studyPlans).some(([planId]) => getUserProgress(planId).started) && (
        <div className="active-plans-section">
          ...
          <div className="plans-grid">
            ...
            {Object.entries(customStudyPlans)
              .filter(([planId]) => getUserProgress(planId).started)
              .map(([planId, plan]) => (
                <PlanCard key={planId} planId={planId} plan={plan} isCustom={true} />
              ))}
          </div>
        </div>
      )}
            ...
            <div className="modal-content">
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => setCustomPlan(prev => ({ ...prev, problemsPerDay: parseInt(e.target.value) }))}
                    min="1"
                    max="10"
                  />
                </div>
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) => setCustomPlan(prev => ({ ...prev, difficulty: e.target.value }))}
                >
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    setCustomPlan(prev => ({ ...prev, algorithms: selected }));
                  }}
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) => setCustomPlan(prev => ({ ...prev, company: e.target.value }))}
                >
              ...
              <div className="plan-summary">
                ...
                <div className="summary-stats">
                  <span>Total Problems: {customPlan.duration * customPlan.problemsPerDay}</span>
                  <span>Daily Commitment: ~{customPlan.problemsPerDay * 20} minutes</span>
                </div>
              </div>
            </div>
      ...
      <div className="study-tips">
        ...
        <div className="tips-grid">
          <div className="tip-card">
            ...
            <p>Better to solve 1-2 problems daily than 20 problems once a week. Build a habit.</p>
          </div>
          
          <div className="tip-card">
            <div className="tip-icon">📝</div>
            <h3>Track Your Progress</h3>
            <p>Review your solutions, note patterns, and track weak areas for focused improvement.</p>
          </div>
          
          <div className="tip-card">
            <div className="tip-icon">🤝</div>
            <h3>Join Communities</h3>
            <p>Discuss solutions, learn different approaches, and stay motivated with peers.</p>
          </div>
          
          <div className="tip-card">
            <div className="tip-icon">⏰</div>
            <h3>Time Management</h3>
            <p>Practice with time constraints. Most interviews allow 20-30 minutes per problem.</p>
          </div>
        </div>
      </div>
    </div>
