            ...
            <div className="card p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                  ...
                  <div className="text-sm text-gray-600 dark:text-slate-300">Questions</div>
                </div>
                <div className="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                  <div className="text-2xl font-bold text-green-600 dark:text-green-400 mb-2">
                    {formatTime(quiz.timeLimit)}
                  </div>
                  <div className="text-sm text-gray-600 dark:text-slate-300">Time Limit</div>
                </div>
                <div className="text-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                  <div className="text-2xl font-bold text-purple-600 dark:text-purple-400 mb-2">
                    {quiz.difficulty}
                  </div>
                  <div className="text-sm text-gray-600 dark:text-slate-300">Difficulty</div>
                </div>
              </div>
            ...
            <div className="card p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                  ...
                  <div className="text-sm text-gray-600 dark:text-slate-300">Correct</div>
                </div>
                <div className="text-center p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
                  <div className="text-2xl font-bold text-red-600 dark:text-red-400 mb-2">
                    {quiz.questions.length - correctAnswers}
                  </div>
                  <div className="text-sm text-gray-600 dark:text-slate-300">Incorrect</div>
                </div>
                <div className="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                  <div className="text-2xl font-bold text-blue-600 dark:text-blue-400 mb-2">
                    {formatTime(quiz.timeLimit - timeLeft)}
                  </div>
                  <div className="text-sm text-gray-600 dark:text-slate-300">Time Used</div>
                </div>
              </div>

              <div className="space-y-4 mb-8">
                {quiz.questions.map((question, index) => (
                  <div key={question.id} className="p-4 border border-gray-200 dark:border-slate-700 rounded-lg">
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                ...
                <span className={`badge ${
                  currentQuestion.difficulty === 'Easy' ? 'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-300' :
