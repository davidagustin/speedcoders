...
export async function POST() {
  try {
    ...
    const quizzes = [
      {
        ...
        description: 'Master string processing, pattern matching, and text manipulation techniques',
        timeLimit: 25,
        difficulty: 'Medium',
        category: 'String',
        createdBy: 'system'
      ...
      },
      {
        ...
        description: 'Core dynamic programming patterns and optimization techniques',
        timeLimit: 35,
        difficulty: 'Hard',
    ...
    return NextResponse.json({ 
      success: true, 
      message: 'Quizzes created successfully with comprehensive questions from batch1.js data' 
    });
...
function getQuestionsForQuiz(category: string, quizId: string) {
  const questions = [];
  ...
  switch (category) {
    case 'String':
      questions.push(
        {
          problemId: 6,
          question: 'What is the most efficient approach for Zigzag Conversion?',
          ...
          explanation: 'Zigzag conversion requires simulating the zigzag pattern using mathematical calculations to determine row positions.',
          order: 1
        },
        {
          problemId: 8,
          question: 'Which algorithms are essential for String to Integer (atoi)?',
          options: JSON.stringify([
          ...
          explanation: 'atoi requires string parsing to handle whitespace, signs, and numeric conversion with overflow checking.',
          order: 2
        },
        {
          problemId: 10,
          question: 'What is the optimal approach for Regular Expression Matching?',
          options: JSON.stringify([
          ...
          explanation: 'Regex matching requires DP to handle complex patterns and recursion for backtracking.',
          order: 3
        },
        {
          problemId: 14,
          question: 'Which data structure is most efficient for Longest Common Prefix?',
          options: JSON.stringify([
            'Trie',
            'Hash Table',
            'Stack',
          ...
          correctAnswer: 'Trie',
          explanation: 'Trie provides O(S) time complexity where S is the sum of all characters in all strings.',
          order: 4
        },
        {
          problemId: 17,
          question: 'What approach is best for Letter Combinations of Phone Number?',
          options: JSON.stringify([
          ...
          explanation: 'Backtracking generates all combinations while hash table maps digits to letters.',
          order: 5
        }
      );
      break;
      ...
      questions.push(
        {
          ...
          explanation: 'Sorting + two pointers provides O(n²) time complexity, which is optimal for this problem.',
          order: 1
        },
        {
          problemId: 18,
          ...
          correctAnswer: 'Two Pointers with Sorting',
          explanation: '4Sum extends 3Sum approach using two pointers after sorting to avoid duplicates.',
          order: 2
        },
        {
          problemId: 80,
          question: 'What is the best approach for Remove Duplicates from Sorted Array II?',
          options: JSON.stringify([
          ...
          explanation: 'Two pointers with counter allows at most two occurrences while maintaining O(1) space.',
          order: 3
        },
        {
          problemId: 81,
          question: 'How to handle Search in Rotated Sorted Array II with duplicates?',
          options: JSON.stringify([
          ...
          explanation: 'Binary search works but requires special handling for duplicate elements.',
          order: 4
        },
        {
          problemId: 164,
          ...
          explanation: 'Bucket sort provides O(n) time complexity using pigeonhole principle.',
          order: 5
        }
      );
      break;
      ...
      questions.push(
        {
          ...
          correctAnswer: 'Dynamic Programming with Recursion',
          explanation: 'DP handles complex regex patterns with recursion for backtracking.',
          order: 1
        },
        {
          problemId: 32,
          ...
          explanation: 'DP tracks valid parentheses length while stack handles matching.',
          order: 2
        },
        {
          problemId: 87,
          ...
          correctAnswer: 'Dynamic Programming with Recursion',
          explanation: 'DP with recursion handles all possible scramble combinations.',
          order: 3
        },
        {
          problemId: 97,
          ...
          explanation: '2D DP tracks if s3 can be formed by interleaving s1 and s2.',
          order: 4
        },
        {
          problemId: 115,
          ...
          explanation: 'DP counts distinct subsequences with memoization for efficiency.',
          order: 5
        }
      );
      break;
    ...
    case 'Tree':
      questions.push(
        {
          problemId: 106,
          question: 'What approach for Construct Binary Tree from Inorder and Postorder?',
          options: JSON.stringify([
          ...
          explanation: 'Divide and conquer builds tree recursively using hash table for O(1) lookups.',
          order: 1
        },
        {
          problemId: 109,
          ...
          explanation: 'Divide and conquer finds middle using two pointers for balanced BST.',
          order: 2
        },
        {
          problemId: 117,
          ...
          explanation: 'BFS connects nodes at same level using level-order traversal.',
          order: 3
        },
        {
          problemId: 144,
          ...
          explanation: 'Stack provides iterative solution, Morris traversal uses O(1) space.',
          order: 4
        },
        {
          problemId: 173,
          ...
          explanation: 'Stack maintains inorder traversal state for O(1) next() calls.',
          order: 5
        }
      );
      break;
      ...
      questions.push(
        {
          ...
          explanation: 'Fast pointer moves n steps ahead, then both move together to find nth from end.',
          order: 1
        },
        {
          problemId: 23,
          ...
          explanation: 'Heap maintains minimum element from all lists for O(n log k) time.',
          order: 2
        },
        {
          problemId: 24,
          ...
          explanation: 'Both approaches work - recursion is elegant, iteration is space-efficient.',
          order: 3
        },
        {
          problemId: 25,
          ...
          explanation: 'Recursion handles k-group reversal while two pointers reverse each group.',
          order: 4
        },
        {
          problemId: 82,
          ...
          explanation: 'Two pointers track current and previous, dummy node handles head removal.',
          order: 5
        }
      );
      break;
    ...
    case 'Backtracking':
      questions.push(
        ...
        },
        {
          ...
          explanation: 'Backtracking generates valid parentheses combinations using DFS.',
          order: 2
        },
        {
          problemId: 37,
          ...
          explanation: 'Backtracking tries all possibilities with constraint propagation for efficiency.',
          order: 3
        },
        {
          problemId: 60,
          ...
          explanation: 'Backtracking with mathematical optimization finds kth permutation efficiently.',
          order: 4
        },
        {
          problemId: 93,
          ...
          explanation: 'Backtracking generates all valid IP address combinations with validation.',
          order: 5
        }
      );
      break;
      ...
      questions.push(
        {
          ...
          explanation: 'LEFT JOIN ensures all records from left table are included even if no match in right table.',
          order: 1
        },
        {
          problemId: 176,
          ...
          explanation: 'Subquery with LIMIT and OFFSET finds second highest salary efficiently.',
          order: 2
        },
        {
          problemId: 178,
          ...
          explanation: 'DENSE_RANK provides ranking without gaps, perfect for score ranking.',
          order: 3
        },
        {
          problemId: 180,
          ...
          explanation: 'Self join finds consecutive numbers, window function provides efficient ranking.',
          order: 4
        },
        {
          problemId: 185,
          ...
          explanation: 'Window function with PARTITION BY department provides top 3 salaries per department.',
          order: 5
        }
      );
      break;
      ...
      questions.push(
        {
          ...
          explanation: 'Mathematical approach with overflow checking is most efficient.',
          order: 1
        },
        {
          problemId: 12,
          ...
          explanation: 'Hash table maps values to symbols, greedy approach uses largest possible values.',
          order: 2
        },
        {
          problemId: 29,
          ...
          explanation: 'Bit manipulation with exponential search provides O(log n) time complexity.',
          order: 3
        },
        {
          problemId: 89,
          ...
          explanation: 'Backtracking generates Gray code sequence using bit manipulation patterns.',
          order: 4
        },
        {
          problemId: 172,
          ...
          explanation: 'Mathematical approach counts factors of 5 using division.',
          order: 5
        }
      );
      break;
