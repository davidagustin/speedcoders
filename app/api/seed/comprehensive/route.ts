	...
	try {
		...
		const learningPaths = [
			{
				...
				description:
					"Master DP from basic concepts to complex patterns like interval DP, tree DP, and state compression",
				category: "beginner",
				difficulty: "Hard",
				duration: 40,
			...
			},
			{
				...
				description:
					"Comprehensive coverage of graph algorithms from basic traversal to advanced network flow",
			...
			},
			{
				...
				description:
					"Master complex string algorithms, pattern matching, and text processing techniques",
				category: "intermediate",
				difficulty: "Hard",
				duration: 30,
				topics: JSON.stringify([
			...
			},
			{
				...
				description:
					"Learn to design efficient data structures and system architectures",
				category: "advanced",
				difficulty: "Hard",
				duration: 45,
				topics: JSON.stringify([
			...
			},
			{
				...
				description:
					"Master complex SQL queries, window functions, and database optimization",
				category: "intermediate",
				difficulty: "Medium",
				duration: 25,
				topics: JSON.stringify([
			...
			},
			{
				...
				description:
					"Advanced mathematical algorithms and number theory concepts",
				category: "advanced",
				difficulty: "Hard",
				duration: 35,
				topics: JSON.stringify([
		...
		const systemDesigns = [
			...
			},
			{
				...
				description:
					"Design an in-memory file system with hierarchical structure",
			...
			},
			{
				...
				description:
					"Design a stack data structure that supports finding the maximum element",
				category: "data-structures",
				difficulty: "Medium",
				requirements: JSON.stringify([
			...
			},
			{
				...
				description:
					"Design a distributed caching system for high-performance applications",
		...
		const algorithms = [
			// Advanced DP Algorithms
			{
				...
				description:
					"DP technique for problems involving intervals or ranges, commonly used in string and array problems",
				timeComplexity: "O(n³)",
				spaceComplexity: "O(n²)",
				examples: JSON.stringify([
					{
						...
						approach:
							"Use 3D DP with states for left, right, and consecutive count",
			...
			},
			{
				...
				category: "Dynamic Programming",
				description:
					"DP technique for problems with multiple states or state transitions",
			...
			},
			{
				...
				category: "Dynamic Programming",
				description:
					"DP technique applied to tree structures, often involving subtree problems",
				timeComplexity: "O(n)",
				spaceComplexity: "O(n)",
				examples: JSON.stringify([
					{
			...
			// Advanced Graph Algorithms
			{
				...
				category: "Graph",
				description:
					"Find shortest paths from multiple source nodes to all other nodes",
			...
			},
			{
				...
				category: "Graph",
				description:
					"Find shortest path with constraints on number of edges or stops",
			...
			// Advanced String Algorithms
			{
				...
				category: "String",
				description:
					"Advanced dynamic programming techniques for string problems",
			...
			},
			{
				...
				category: "String",
				description:
					"Specialized trie structures for complex string operations",
			...
			// Advanced Array Algorithms
			{
				...
				category: "Array",
				description:
					"Advanced segment tree technique for range updates and queries",
			...
			},
			{
				...
				category: "Array",
				description:
					"Advanced monotonic stack techniques for complex array problems",
				timeComplexity: "O(n)",
				spaceComplexity: "O(n)",
				examples: JSON.stringify([
					{
			...
			// Advanced Design Patterns
			{
				...
				category: "Design",
				description:
					"Design patterns for complex data structures with multiple operations",
			...
			// Advanced Math Algorithms
			{
				...
				category: "Math",
				description:
					"Mathematical algorithms combined with binary search optimization",
