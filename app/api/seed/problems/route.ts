  ...
  try {
    ...
    const problems = [
      // String Problems
      {
        ...
        difficulty: 'Medium',
        category: 'String',
        description: 'Convert a string to a zigzag pattern on a given number of rows.',
      ...
      },
      {
        ...
        examples: JSON.stringify([
          { input: 's = "42"', output: '42', explanation: 'Leading whitespace is ignored and "42" is parsed as 42.' },
          { input: 's = "   -42"', output: '-42', explanation: 'Leading whitespace is ignored, the minus sign is read, then "42" is parsed as -42.' },
          { input: 's = "4193 with words"', output: '4193', explanation: 'Parsing stops at the first non-digit character.' }
        ]),
        constraints: JSON.stringify([
          '0 <= s.length <= 200',
      ...
      },
      {
        ...
        solutions: JSON.stringify(['String', 'Dynamic Programming', 'Recursion']),
      ...
      },
      {
        ...
        difficulty: 'Medium',
        category: 'Array',
        description: 'Given an array nums of n integers, return an array of all the unique quadruplets [nums[a], nums[b], nums[c], nums[d]] such that a, b, c, and d are distinct.',
        examples: JSON.stringify([
          { input: 'nums = [1,0,-1,0,-2,2], target = 0', output: '[[-2,-1,1,2],[-2,0,0,2],[-1,0,0,1]]', explanation: 'The quadruplets that sum to 0 are shown.' },
          { input: 'nums = [2,2,2,2,2], target = 8', output: '[[2,2,2,2]]', explanation: 'The only quadruplet that sums to 8.' }
        ]),
        constraints: JSON.stringify([
          '1 <= nums.length <= 200',
          '-109 <= nums[i] <= 109',
      ...
      },
      {
        ...
        examples: JSON.stringify([
          { input: 'nums = [2,5,6,0,0,1,2], target = 0', output: 'true', explanation: '0 is found in the array.' },
          { input: 'nums = [2,5,6,0,0,1,2], target = 3', output: 'false', explanation: '3 is not found in the array.' }
        ]),
        constraints: JSON.stringify([
          '1 <= nums.length <= 5000',
          '-104 <= nums[i] <= 104',
      ...
      },
      {
        ...
        examples: JSON.stringify([
          { input: 's1 = "great", s2 = "rgeat"', output: 'true', explanation: 'One possible scenario applied on s1 is: "great" --> "gr/eat" --> "gr/eat" --> "rgeat".' },
          { input: 's1 = "abcde", s2 = "caebd"', output: 'false', explanation: 'It is impossible to scramble s1 to get s2.' }
        ]),
        constraints: JSON.stringify([
          's1.length == s2.length',
          '1 <= s1.length <= 30',
      ...
      },
      {
        ...
        examples: JSON.stringify([
          { input: 's1 = "aabcc", s2 = "dbbca", s3 = "aadbbcbcac"', output: 'true', explanation: 's3 is formed by interleaving s1 and s2.' },
          { input: 's1 = "aabcc", s2 = "dbbca", s3 = "aadbbbaccc"', output: 'false', explanation: 's3 cannot be formed by interleaving s1 and s2.' }
        ]),
        constraints: JSON.stringify([
      ...
      },
      {
        ...
        examples: JSON.stringify([
          ...
          { input: 's = "babgbag", t = "bag"', output: '5', explanation: 'There are 5 ways to generate "bag" from "babgbag".' }
        ]),
        constraints: JSON.stringify([
      ...
      // Tree Problems
      {
        ...
        examples: JSON.stringify([
          { input: 'inorder = [9,3,15,20,7], postorder = [9,15,7,20,3]', output: '[3,9,20,null,null,15,7]', explanation: 'The binary tree is constructed from the traversals.' },
          { input: 'inorder = [-1], postorder = [-1]', output: '[-1]', explanation: 'Single node tree.' }
        ]),
        constraints: JSON.stringify([
        ...
        solutions: JSON.stringify(['Array', 'Hash Table', 'Divide and Conquer', 'Tree']),
      ...
      },
      {
        ...
        examples: JSON.stringify([
          { input: 'head = [-10,-3,0,5,9]', output: '[0,-3,9,-10,null,5]', explanation: 'A height balanced BST is constructed.' },
          { input: 'head = []', output: '[]', explanation: 'Empty list results in empty tree.' }
        ]),
        constraints: JSON.stringify([
          'The number of nodes in head is in the range [0, 2 * 104].',
          '-105 <= Node.val <= 105'
        ]),
        solutions: JSON.stringify(['Linked List', 'Divide and Conquer', 'Tree']),
      ...
      },
      {
        ...
        examples: JSON.stringify([
          { input: 'root = [1,2,3,4,5,null,7]', output: '[1,#,2,3,#,4,5,7,#]', explanation: 'Next pointers are populated.' },
      ...
      },
      {
        ...
        examples: JSON.stringify([
          { input: 'root = [1,null,2,3]', output: '[1,2,3]', explanation: 'Preorder traversal visits root, left, right.' },
          { input: 'root = []', output: '[]', explanation: 'Empty tree.' }
        ]),
        constraints: JSON.stringify([
      ...
      },
      {
        ...
        examples: JSON.stringify([
          { input: '["BSTIterator", "next", "next", "hasNext", "next", "hasNext", "next", "hasNext", "next", "hasNext"]\n[[[7, 3, 15, null, null, 9, 20]], [], [], [], [], [], [], [], [], []]', output: '[null, 3, 7, true, 9, true, 15, true, 20, false]', explanation: 'Iterator traverses BST in-order.' }
        ]),
        constraints: JSON.stringify([
      ...
      // Linked List Problems
      {
        ...
        examples: JSON.stringify([
          { input: 'head = [1,2,3,4,5], n = 2', output: '[1,2,3,5]', explanation: 'Remove the 2nd node from the end (node with value 4).' },
      ...
      },
      {
        ...
        examples: JSON.stringify([
          { input: 'lists = [[1,4,5],[1,3,4],[2,6]]', output: '[1,1,2,3,4,4,5,6]', explanation: 'Merge all sorted lists.' },
        ...
        solutions: JSON.stringify(['Linked List', 'Divide and Conquer', 'Heap']),
      ...
      },
      {
        ...
        examples: JSON.stringify([
          { input: 'head = [1,2,3,4,5], k = 2', output: '[2,1,4,3,5]', explanation: 'Reverse nodes in groups of 2.' },
          { input: 'head = [1,2,3,4,5], k = 3', output: '[3,2,1,4,5]', explanation: 'Reverse nodes in groups of 3.' }
        ]),
        constraints: JSON.stringify([
      ...
      },
      {
        ...
        examples: JSON.stringify([
          { input: 'head = [1,2,3,3,4,4,5]', output: '[1,2,5]', explanation: 'Remove all nodes with duplicates.' },
          { input: 'head = [1,1,1,2,3]', output: '[2,3]', explanation: 'Remove all nodes with value 1.' }
        ]),
        constraints: JSON.stringify([
      ...
      // Database Problems
      {
        ...
        difficulty: 'Easy',
        category: 'Database',
        description: 'Write a SQL query to get the names of customers who have made orders.',
        examples: JSON.stringify([
          { input: 'Person table: [[1, "John", "Doe"], [2, "Jane", "Smith"]]\nOrders table: [[1, 1, "Order1"], [2, 2, "Order2"]]', output: '[["John", "Order1"], ["Jane", "Order2"]]', explanation: 'LEFT JOIN combines customer names with their orders.' }
        ]),
        constraints: JSON.stringify([
      ...
      },
      {
        ...
        examples: JSON.stringify([
          { input: 'Employee table: [[1, 100], [2, 200], [3, 300]]', output: '200', explanation: 'Second highest salary is 200.' },
          { input: 'Employee table: [[1, 100]]', output: 'null', explanation: 'No second highest salary.' }
        ]),
        constraints: JSON.stringify([
      ...
      },
      {
        ...
        examples: JSON.stringify([
          { input: 'Scores table: [[1, 3.50], [2, 3.65], [3, 4.00], [4, 3.85], [5, 4.00], [6, 3.65]]', output: '[[4.00, 1], [4.00, 1], [3.85, 2], [3.65, 3], [3.65, 3], [3.50, 4]]', explanation: 'DENSE_RANK provides ranking without gaps.' }
        ]),
        constraints: JSON.stringify([
      ...
      },
      {
        ...
        examples: JSON.stringify([
          { input: 'Logs table: [[1, 1], [2, 1], [3, 1], [4, 2], [5, 1], [6, 2], [7, 2]]', output: '[1]', explanation: '1 appears three times consecutively.' }
        ]),
        constraints: JSON.stringify([
      ...
      },
      {
        ...
        examples: JSON.stringify([
          { input: 'Employee table: [[1, "Joe", 70000, 1], [2, "Henry", 80000, 2], [3, "Sam", 60000, 2], [4, "Max", 90000, 1]]\nDepartment table: [[1, "IT"], [2, "Sales"]]', output: '[["IT", "Max", 90000], ["Sales", "Henry", 80000]]', explanation: 'Top salary per department.' }
        ]),
        constraints: JSON.stringify([
