...
const editorialDatabase: Record<string, EditorialContent> = {
    ...
    public int[] twoSum(int[] nums, int target) {
        ...
        return new int[] {};
				...
				explanation:
					"The brute force approach checks every possible pair of elements in the array. For each element, we check if there's another element that sums to the target.",
			},
			{
				name: "Hash Map",
    ...
    public int[] twoSum(int[] nums, int target) {
        ...
        return new int[] {};
				...
				explanation:
					"The hash map approach is more efficient. For each element, we check if its complement (target - current_element) exists in the hash map. If found, we return the indices.",
			},
		],
    ...
    public ListNode addTwoNumbers(ListNode l1, ListNode l2) {
        ...
        return dummyHead.next;
				...
				explanation:
					"We simulate the elementary math addition process. We iterate through both linked lists, adding corresponding digits and handling the carry.",
			},
		],
    ...
    public int lengthOfLongestSubstring(String s) {
        ...
        return res;
				...
				explanation:
					"We use a sliding window approach with two pointers. The right pointer expands the window, and the left pointer contracts it when we encounter a repeating character.",
			},
		],
    ...
    public double findMedianSortedArrays(int[] nums1, int[] nums2) {
        ...
        throw new IllegalArgumentException();
				...
				explanation:
					"We use binary search to find the correct partition point. The key insight is that the median divides both arrays into left and right halves.",
			},
		],
    ...
    private int expandAroundCenter(String s, int left, int right) {
        ...
        return R - L - 1;
				...
				explanation:
					"We expand around each character and between characters to find palindromes. This approach is more intuitive than dynamic programming.",
			},
			{
    ...
    public String longestPalindrome(String s) {
        ...
        return s.substring(start, start + maxLen);
				...
				explanation:
					"We use a 2D DP table where dp[i][j] represents if substring from i to j is a palindrome.",
			},
		],
    ...
    public int maxArea(int[] height) {
        ...
        return maxArea;
				...
				explanation:
					"We use two pointers starting from both ends. The key insight is that we always move the pointer with the smaller height.",
			},
		],
    ...
    public List<List<Integer>> threeSum(int[] nums) {
        ...
        return result;
				...
				explanation:
					"We sort the array first, then for each element, we use two pointers to find pairs that sum to the negative of the current element.",
			},
		],
    ...
    public ListNode removeNthFromEnd(ListNode head, int n) {
        ...
        return dummy.next;
				...
				explanation:
					"We first count the total number of nodes, then calculate which node to remove from the beginning.",
			},
			{
				name: "One Pass",
    ...
    public ListNode removeNthFromEnd(ListNode head, int n) {
        ...
        return dummy.next;
				...
				explanation:
					"We use two pointers with n+1 distance apart. When the first pointer reaches the end, the second pointer is at the node before the one to be removed.",
			},
		],
    ...
    public ListNode mergeTwoLists(ListNode l1, ListNode l2) {
        ...
        return dummy.next;
				...
				explanation:
					"We compare the values of nodes from both lists and link the smaller one to our result list.",
			},
			{
				name: "Recursive",
    ...
    public ListNode mergeTwoLists(ListNode l1, ListNode l2) {
        ...
        if (l1.val < l2.val) {
            ...
            return l2;
				...
				explanation:
					"We use recursion to merge the lists. The base case is when one of the lists is null.",
			},
		],
