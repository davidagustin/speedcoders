  ...
  const topics = [
    {
      ...
      lessons: [
        ...
        { id: 2, title: "Array Traversal", duration: "20 min", completed: true },
        { id: 3, title: "Two Pointers Technique", duration: "25 min", completed: false },
        { id: 4, title: "Sliding Window", duration: "30 min", completed: false },
      ]
    },
    {
      id: "strings",
      ...
      lessons: [
        ...
        { id: 2, title: "String Manipulation", duration: "20 min", completed: true },
        { id: 3, title: "Pattern Matching", duration: "25 min", completed: false },
        { id: 4, title: "Regular Expressions", duration: "30 min", completed: false },
      ]
    },
    {
      id: "linked-lists",
      ...
      progress: 40,
      lessons: [
        { id: 1, title: "Linked List Basics", duration: "15 min", completed: true },
        { id: 2, title: "Traversal and Search", duration: "20 min", completed: false },
        { id: 3, title: "Insertion and Deletion", duration: "25 min", completed: false },
        { id: 4, title: "Advanced Operations", duration: "30 min", completed: false },
      ]
    },
    {
      id: "trees",
      ...
      lessons: [
        ...
        { id: 2, title: "Tree Traversal", duration: "20 min", completed: false },
        { id: 3, title: "Binary Search Trees", duration: "25 min", completed: false },
        { id: 4, title: "Balanced Trees", duration: "30 min", completed: false },
      ]
    },
    {
      id: "graphs",
      ...
      lessons: [
        ...
        { id: 2, title: "Graph Traversal", duration: "20 min", completed: false },
        { id: 3, title: "Shortest Path", duration: "25 min", completed: false },
        { id: 4, title: "Minimum Spanning Tree", duration: "30 min", completed: false },
      ]
    },
    {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900">Please sign in to study</h1>
          <Link href="/auth/login" className="mt-4 inline-block bg-blue-600 text-white px-6 py-2 rounded-lg">
            Sign In
          </Link>
        </div>
      </div>
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="text-right">
                          <div className="text-sm font-medium text-gray-900">{topic.progress}%</div>
                ...
                {selectedTopicData ? (
                  <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center space-x-3 mb-6">
                      ...
                      <div>
                        <h2 className="text-2xl font-bold text-gray-900">{selectedTopicData.name}</h2>
                    ...
                    <div className="mb-6">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm text-gray-500">{selectedTopicData.progress}% complete</span>
                      </div>
                  ...
                  <div className="bg-white rounded-lg shadow p-12 text-center">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Select a topic to start studying</h3>
                    <p className="text-gray-600">
                      Choose a topic from the list to view lessons and track your progress.
                    </p>
                  </div>
                )}
              </div>
