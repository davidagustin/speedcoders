export const comprehensiveProblems = [
  ...
  // Additional problems from README
  {
    ...
    editorial: {
      approach: "Use sliding window technique with a hash set to track unique characters.",
      timeComplexity: "O(n)",
      spaceComplexity: "O(min(m, n))",
      solutions: [
        {
          name: "Sliding Window",
          description: "Maintain a window of unique characters using two pointers and a hash set.",
  ...
  },
  {
    ...
    editorial: {
      approach: "Use binary search to find the correct partition point that divides both arrays into left and right halves.",
      timeComplexity: "O(log(min(m, n)))",
      spaceComplexity: "O(1)",
      solutions: [
        {
          name: "Binary Search Approach",
          description: "Find the partition point using binary search on the smaller array.",
  ...
  },
  {
    ...
    editorial: {
      approach: "Use dynamic programming or expand around center technique to find the longest palindrome.",
      timeComplexity: "O(n²)",
      spaceComplexity: "O(n²)",
      solutions: [
        {
          name: "Expand Around Center",
          description: "For each character, expand around it to find the longest palindrome.",
  ...
  },
  {
    ...
    editorial: {
      approach: "Simulate the zigzag pattern by tracking the current row and direction.",
      timeComplexity: "O(n)",
      spaceComplexity: "O(n)",
      solutions: [
        {
          name: "Row-by-Row Approach",
          description: "Build the result string row by row by tracking the zigzag pattern.",
  ...
  },
  {
    ...
    editorial: {
      approach: "Extract digits one by one and build the reversed number, handling overflow.",
      timeComplexity: "O(log n)",
      spaceComplexity: "O(1)",
      solutions: [
        {
          name: "Digit Extraction",
          description: "Extract digits and build reversed number while checking for overflow.",
  ...
  },
  {
    ...
    editorial: {
      approach: "Parse the string character by character, handling whitespace, signs, and overflow.",
      timeComplexity: "O(n)",
      spaceComplexity: "O(1)",
      solutions: [
        {
          name: "Character-by-Character Parsing",
          description: "Parse the string step by step, handling all edge cases.",
  ...
  },
  {
    ...
    editorial: {
      approach: "Convert to string and check if it reads the same forwards and backwards, or reverse the number mathematically.",
      timeComplexity: "O(log n)",
      spaceComplexity: "O(1)",
      solutions: [
        {
  ...
  },
  {
    ...
    editorial: {
      approach: "Use dynamic programming to match the pattern against the string recursively.",
      timeComplexity: "O(mn)",
      spaceComplexity: "O(mn)",
      solutions: [
        {
          name: "Dynamic Programming",
          description: "Use DP table to track matching states for each position.",
  ...
  },
  {
    ...
    editorial: {
      approach: "Use two pointers starting from both ends and move the pointer with smaller height inward.",
      timeComplexity: "O(n)",
      spaceComplexity: "O(1)",
      solutions: [
        {
  ...
  },
  {
    ...
    editorial: {
      approach: "Use a mapping of integer values to roman numerals and build the result.",
      timeComplexity: "O(1)",
      spaceComplexity: "O(1)",
      solutions: [
        {
  ...
  },
  {
    ...
    editorial: {
      approach: "Process the roman numeral from left to right, handling special cases where a smaller value precedes a larger one.",
      timeComplexity: "O(n)",
      spaceComplexity: "O(1)",
      solutions: [
        {
  ...
  },
  {
    ...
    editorial: {
      approach: "Compare characters at the same position across all strings until a mismatch is found.",
      timeComplexity: "O(S)",
      spaceComplexity: "O(1)",
      solutions: [
        {
  ...
  },
  {
    ...
    editorial: {
      approach: "Sort the array and use two pointers to find triplets that sum to zero.",
      timeComplexity: "O(n²)",
      spaceComplexity: "O(1)",
      solutions: [
        {
          name: "Two Pointers Approach",
          description: "Sort array and use two pointers to find valid triplets.",
...
export const easyProblems = comprehensiveProblems.filter(p => p.difficulty === 'Easy');
export const mediumProblems = comprehensiveProblems.filter(p => p.difficulty === 'Medium');
export const hardProblems = comprehensiveProblems.filter(p => p.difficulty === 'Hard');
...
export const algorithmCategories = [
  ...
  "XOR", "Kadane's Algorithm", "Floyd's Cycle Detection", "Morris Traversal",
  "Expand Around Center", "Brute Force", "Iteration", "Memoization"
];
