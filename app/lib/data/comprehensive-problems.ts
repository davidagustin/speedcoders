...
import { batch3Problems, batch4Problems, batch5Problems, batch6Problems, batch7Problems } from './problemGenerator'
...
export const comprehensiveProblems: ComprehensiveProblem[] = allBatchProblems.map(problem => ({
  id: problem.id,
  title: problem.title,
  ...
  leetcodeUrl: (problem as any).url || `https://leetcode.com/problems/${problem.title.toLowerCase().replace(/\s+/g, '-')}/`,
  editorial: {
    solutions: [
      {
  ...
  // Time: O(n), Space: O(1)
    ...
    hints: [
      { level: "easy", text: `Consider using ${problem.algorithms[0]} approach.` },
      { level: "medium", text: `Think about how ${problem.correctAlgorithms.join(' and ')} can be applied.` },
      { level: "hard", text: `Optimize the solution using ${problem.correctAlgorithms.join(' and ')}.` }
    ],
    keyInsights: [
...
export const algorithmCategories = {
  "Array & Matrix": [
    "Array", "Matrix", "Two Pointers", "Sliding Window", "Prefix Sum", 
    "Suffix Sum", "Kadane's Algorithm", "Dutch National Flag", "Moore's Voting"
  ],
  "String Processing": [
    "String", "String Matching", "KMP Algorithm", "Rabin-Karp", "Z Algorithm",
    "Manacher's Algorithm", "Trie", "Suffix Array", "Rolling Hash"
  ],
  "Hash & Set": [
    "Hash Table", "Hash Set", "Hash Map", "Counting", "Frequency Map",
    "Bloom Filter", "Load Factor", "Collision Resolution"
  ],
  "Linked Lists": [
    "Linked List", "Doubly Linked List", "Circular List", "Fast & Slow Pointers",
    "Floyd's Cycle Detection", "List Reversal", "List Merging"
  ],
  "Trees & Graphs": [
    "Tree", "Binary Tree", "Binary Search Tree", "N-ary Tree", "Trie",
    "Graph", "DFS", "BFS", "Topological Sort", "Union Find", "Spanning Tree"
  ],
  "Advanced Tree Algorithms": [
    "Segment Tree", "Binary Indexed Tree", "Cartesian Tree", "Treap",
    "Splay Tree", "Red-Black Tree", "AVL Tree", "B-Tree"
  ],
  "Stack & Queue": [
  ...
  "Sorting & Searching": [
    "Sorting", "Binary Search", "Merge Sort", "Quick Sort", "Heap Sort",
    "Counting Sort", "Radix Sort", "Bucket Sort", "Quickselect"
  ],
  "Dynamic Programming": [
    "Dynamic Programming", "Memoization", "Tabulation", "1D DP", "2D DP",
    "Interval DP", "Tree DP", "Digit DP", "Bitmask DP", "State Machine DP"
  ],
  "Greedy Algorithms": [
    "Greedy", "Activity Selection", "Huffman Coding", "Fractional Knapsack",
    "Job Scheduling", "Optimal Merge Pattern"
  ],
  "Backtracking": [
    "Backtracking", "N-Queens", "Sudoku Solver", "Permutations", "Combinations",
    "Subset Generation", "Graph Coloring", "Knight's Tour"
  ],
  "Divide & Conquer": [
    "Divide and Conquer", "Master Theorem", "Merge Sort", "Quick Sort",
    "Binary Search", "Closest Pair", "Matrix Multiplication"
  ],
  "Mathematical": [
    "Math", "Number Theory", "Prime Numbers", "GCD", "LCM", "Modular Arithmetic",
    "Combinatorics", "Probability", "Statistics", "Geometry"
  ],
  "Bit Manipulation": [
    "Bit Manipulation", "Bitwise AND", "Bitwise OR", "Bitwise XOR", 
    "Bit Shifting", "Brian Kernighan's Algorithm", "Bit Counting"
  ],
  "Graph Algorithms": [
    "Shortest Path", "Dijkstra's Algorithm", "Bellman-Ford", "Floyd-Warshall",
    "A* Algorithm", "Minimum Spanning Tree", "Kruskal's Algorithm", "Prim's Algorithm"
  ],
  "Advanced Topics": [
    "Meet in the Middle", "Heavy-Light Decomposition", "Centroid Decomposition",
    "Mo's Algorithm", "Sqrt Decomposition", "Persistent Data Structures"
  ],
  "Game Theory": [
    "Game Theory", "Minimax", "Alpha-Beta Pruning", "Nash Equilibrium",
    "Nim Game", "Sprague-Grundy Theorem"
  ],
  "Computational Geometry": [
    "Geometry", "Convex Hull", "Line Sweep", "Closest Pair of Points",
    "Polygon Area", "Point in Polygon", "Line Intersection"
  ],
  "String Algorithms": [
    "Suffix Tree", "Suffix Array", "LCP Array", "Burrows-Wheeler Transform",
    "Edit Distance", "Longest Common Subsequence", "Palindrome Detection"
  ],
  "Network Flow": [
    "Max Flow", "Min Cut", "Ford-Fulkerson", "Edmonds-Karp", "Dinic's Algorithm",
    "Push-Relabel", "Minimum Cost Flow"
  ],
  "Design Patterns": [
    "Design", "Iterator Pattern", "Observer Pattern", "Factory Pattern",
...
export function getProblemsByAlgorithm(algorithm: string) {
  return comprehensiveProblems.filter(p => 
    p.algorithms.includes(algorithm) || p.correctAlgorithms.includes(algorithm)
  )
}
...
export function getRandomProblems(count: number, difficulty?: string, category?: string) {
