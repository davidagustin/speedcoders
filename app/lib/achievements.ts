export interface Achievement {
  ...
  category: 'solving' | 'streak' | 'speed' | 'accuracy' | 'algorithm' | 'special';
  requirement: {
...
export class AchievementSystem {
  ...
  private initializeAchievements() {
    this.achievements = [
      ...
      },
      {
        ...
        reward: { experience: 1000, badge: 'marathon', title: 'Marathon Runner' },
        isSecret: false
      },
      ...
      },
      {
        ...
        rarity: 'rare',
        category: 'speed',
        requirement: { type: 'time', value: 600, condition: 'difficulty:Medium' },
      ...
      },
      {
        ...
        reward: { experience: 500, badge: 'sharpshooter', title: 'Sharpshooter' },
        isSecret: false
      },
      ...
      },
      {
        ...
        rarity: 'rare',
        category: 'algorithm',
        requirement: { type: 'count', value: 20, condition: 'category:Dynamic Programming' },
      ...
      // Special Achievements
      {
        ...
        rarity: 'common',
        category: 'special',
        requirement: { type: 'special', value: 1, condition: 'time:before-6am' },
      ...
      },
      {
        ...
        rarity: 'common',
        category: 'special',
        requirement: { type: 'special', value: 1, condition: 'time:after-11pm' },
      ...
      },
      {
        ...
        rarity: 'rare',
        category: 'special',
        requirement: { type: 'special', value: 3, condition: 'languages:different' },
      ...
      },
      {
        ...
        rarity: 'rare',
        category: 'special',
        requirement: { type: 'count', value: 5, condition: 'contests:participated' },
      ...
      },
      {
        ...
        rarity: 'epic',
        category: 'special',
        requirement: { type: 'special', value: 1, condition: 'contest:top-10-percent' },
        reward: { experience: 500, badge: 'top-performer', title: 'Elite Performer' },
        isSecret: false
      },
      ...
      // Secret Achievements
      {
        ...
        rarity: 'epic',
        category: 'special',
        requirement: { type: 'special', value: 1, condition: 'first-attempt:Hard' },
      ...
      },
      {
        ...
        rarity: 'rare',
        category: 'special',
        requirement: { type: 'count', value: 100, condition: 'errors:compilation' },
      ...
      },
      {
        ...
        rarity: 'epic',
        category: 'special',
        requirement: { type: 'special', value: 1, condition: 'attempts:10-plus' },
        reward: { experience: 250, badge: 'persistent', title: 'Never Give Up' },
        isSecret: true
      },
      {
        id: 'midnight-coder',
        ...
        rarity: 'rare',
        category: 'special',
        requirement: { type: 'count', value: 5, condition: 'time:exactly-midnight' },
      ...
      },
      {
        ...
        rarity: 'rare',
        category: 'special',
        requirement: { type: 'special', value: 7, condition: 'daily-count:exact' },
  ...
  checkAchievements(userId: string, activity: {
  ...
  private checkCountRequirement(achievement: Achievement, activity: any): boolean {
    ...
    if (condition.startsWith('category:')) {
      const category = condition.split(':')[1];
  ...
  private calculateCountProgress(achievement: Achievement, activity: any): number {
    const condition = achievement.requirement.condition;
  ...
  private checkTimeRequirement(achievement: Achievement, activity: any): boolean {
    const condition = achievement.requirement.condition;
    
    if (condition?.includes('difficulty:')) {
      const difficulty = condition.split(':')[1];
      return activity.difficulty === difficulty && activity.solveTime <= achievement.requirement.value;
    }

    return activity.solveTime <= achievement.requirement.value;
  }

  private checkAccuracyRequirement(achievement: Achievement, activity: any): boolean {
  ...
  private checkSpecialRequirement(achievement: Achievement, activity: any): boolean {
    const condition = achievement.requirement.condition;
    ...
    if (condition === 'time:exactly-midnight') {
      return activity.timestamp.getHours() === 0 && activity.timestamp.getMinutes() === 0;
    }
  ...
  private updateAchievementProgress(userId: string, achievementId: string, progress: number) {
    if (!this.userAchievements.has(userId)) {
      this.userAchievements.set(userId, []);
    }
