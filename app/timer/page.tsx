                  ...
                  <div className="w-64 h-64 rounded-full border-8 border-gray-200 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <div className="text-sm text-gray-500">
                        {currentPhase === 'work' ? 'minutes remaining' : 'break time'}
                      </div>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg font-semibold text-gray-900">{currentSession}</span>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                      />
                      <span className="ml-2 text-sm text-gray-700">Auto-start pomodoros</span>
                    </label>
