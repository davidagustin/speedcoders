    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Master algorithms and data structures with our enhanced quiz system</p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              {userProgress.length > 0 ? (
                  ...
                  {userProgress.slice(0, 5).map((attempt) => (
                    <div key={attempt.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <div className="font-semibold text-gray-900">{attempt.score}%</div>
                ...
                <p className="text-gray-600 text-center py-4">No attempts yet. Start your first quiz!</p>
              )}
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              {availableQuizzes.length > 0 ? (
                ...
                <p className="text-gray-600 text-center py-4">No quizzes available. Create your own!</p>
              )}
            </div>
          </div>
        </div>
