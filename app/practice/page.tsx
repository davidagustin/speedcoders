    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900">Please sign in to practice</h1>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="bg-white rounded-lg shadow p-6 mb-8">
              ...
              <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex items-end">
                  <button
                    onClick={() => setFilters({ difficulty: "", category: "", yoloMode: false })}
            ...
            {!loading && filteredProblems.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">Try adjusting your filters or check back later for new problems.</p>
              </div>
            )}
          </div>
        </main>
