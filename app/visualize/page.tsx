...
export default function VisualizePage() {
  ...
  const algorithms: Record<string, Visualization> = {
    ...
    'quick-sort': {
      ...
      name: 'Quick Sort',
      type: 'sorting',
      description: 'Divides array into smaller sub-arrays around a pivot element',
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold">{algorithms[selectedAlgo]?.name}</h3>
              ...
              {algorithms[selectedAlgo]?.type === 'sorting' && (
                <div className="mb-6">
                  <div className="flex justify-center items-end gap-1" style={{ height: '300px' }}>
              ...
              <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                ...
                <div className="flex gap-6 text-sm">
                  <div>
                    ...
                    <span className="text-indigo-600">{algorithms[selectedAlgo]?.complexity.time}</span>
                  </div>
                  <div>
                    <span className="font-medium">Space Complexity:</span>{' '}
                    <span className="text-purple-600">{algorithms[selectedAlgo]?.complexity.space}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-gradient-to-r from-blue-500 to-indigo-500 rounded-xl p-6 text-white">
            ...
            <p className="text-sm opacity-90 mb-4">Bubble, Quick, Merge, Heap Sort</p>
            <div className="text-3xl">📊</div>
          </div>
          <div className="bg-gradient-to-r from-green-500 to-teal-500 rounded-xl p-6 text-white">
            <h3 className="text-xl font-bold mb-2">Searching Algorithms</h3>
            <p className="text-sm opacity-90 mb-4">Binary, Linear, Jump Search</p>
            <div className="text-3xl">🔍</div>
          </div>
          ...
          <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-xl p-6 text-white">
            ...
            <p className="text-sm opacity-90 mb-4">Knapsack, LCS, Edit Distance</p>
            <div className="text-3xl">🧩</div>
          </div>
        </div>
      </div>
