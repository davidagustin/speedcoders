      ...
      const mockDesigns: SystemDesign[] = [
        {
          ...
          estimatedTime: 45,
          tags: ['URL Shortening', 'Hash Functions', 'Caching', 'Database Design']
        },
        {
          id: '2',
          ...
          estimatedTime: 60,
          tags: ['Real-time', 'WebSockets', 'Message Queues', 'Push Notifications']
        },
        {
          id: '3',
        ...
        },
        {
          ...
          estimatedTime: 75,
          tags: ['Distributed Systems', 'Consistent Hashing', 'Replication', 'Fault Tolerance']
        },
        {
          id: '5',
              ...
              <div className="p-6">
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="text-right">
                    <div className="text-sm text-gray-500">{design.estimatedTime} min</div>
                  </div>
                </div>
