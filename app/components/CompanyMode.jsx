...
function CompanyMode({ user }) {
	...
	const getCompanyStats = (company) => {
		...
		const problems = allLeetcodeProblems.filter((p) =>
						...
						>
							<div className="company-header">
								...
								<div className="company-difficulty">
									<span
										className={`difficulty-badge ${info.difficulty.toLowerCase().replace("-", "_")}`}
									>
										{info.difficulty}
									</span>
								</div>
							...
							<div className="company-progress">
								...
								<span className="progress-text">
									{stats.total > 0
										? Math.round((progress.solved / stats.total) * 100)
										: 0}
									% Complete
								</span>
							</div>
			...
			<div className="company-insights">
				...
				<div className="tips-grid">
					<div className="tip-card">
						...
						<p>
							Master arrays, strings, and basic data structures first. They
							appear in 80% of interviews.
						</p>
					</div>
					...
					<div className="tip-card">
						...
						<p>
							Aim for 15-20 minutes per medium problem. Speed comes with
							consistent practice.
						</p>
					</div>
					...
					<div className="tip-card">
						...
						<p>
							Explain your approach before coding. Interviewers want to
					...
					<div className="tip-card">
						...
						<p>
							Understand the problem fully. Edge cases, constraints, and
