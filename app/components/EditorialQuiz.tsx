	...
	return (
		<div className="max-w-6xl mx-auto p-6">
			...
			<div className="flex items-center justify-between mb-6">
				...
				<div
					className={`text-2xl font-mono ${timeLeft < 60 ? "text-red-600" : "text-blue-600"}`}
				>
					{formatTime(timeLeft)}
				</div>
			</div>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
						...
						{showHint && (
							<div className="mt-3 p-4 bg-blue-50 border border-blue-200 rounded-lg">
								<p className="text-blue-800 text-sm">
									Think about what data structures and algorithms would be most
									efficient for this problem. Consider the time and space
				...
				<div className="bg-white rounded-lg shadow-sm border p-6">
					...
					<p className="text-gray-600 mb-6">
						Choose the best algorithm(s) to solve this problem. You can select
						multiple approaches.
					</p>
