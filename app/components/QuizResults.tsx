	...
	return (
		<div className="max-w-4xl mx-auto p-6">
			...
			<div className="text-center mb-8">
				<div
					className={`inline-flex items-center px-4 py-2 rounded-full text-lg font-semibold ${badge.color} mb-4`}
				>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
				...
				<div className="bg-white p-6 rounded-lg shadow-sm border">
					...
					<div className="space-y-4">
						{Object.entries(result.difficultyBreakdown).map(
							([difficulty, stats]) => (
								<div
									key={difficulty}
						...
						>
							<div>
								...
								<div className="text-xs text-gray-600">
									{algo.correct}/{algo.total} correct
								</div>
							</div>
							<div
								className={`text-sm font-semibold ${getScoreColor(algo.percentage)}`}
							>
								{algo.percentage}%
							</div>
						</div>
