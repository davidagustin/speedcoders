...
export default function QuizResults({ result, onRetry, onNewQuiz }: QuizResultsProps) {
  ...
  const getScoreBadge = (score: number) => {
    ...
    if (score >= 70) return { text: 'Good Job!', color: 'bg-blue-100 text-blue-800', icon: '👍' };
    if (score >= 50) return { text: 'Keep Trying!', color: 'bg-yellow-100 text-yellow-800', icon: '⚡' };
    return { text: 'Practice More!', color: 'bg-red-100 text-red-800', icon: '💪' };
  };
