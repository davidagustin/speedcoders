...
export default function StudyPlanner({
  ...
  const [activeTab, setActiveTab] = useState<"sessions" | "goals" | "calendar">("sessions");
  ...
  const topics = [
    ...
    "Hash Tables", "Stacks", "Queues", "Heaps", "Sorting", "Recursion"
  ];

  const difficulties = ["Easy", "Medium", "Hard"];
  const priorities = ["low", "medium", "high"];
  const categories = ["Algorithms", "Data Structures", "System Design", "Problem Solving", "Interview Prep"];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-purple-50 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-900">{Math.round(totalStudyTime / 60)}h</p>
              </div>
          ...
          <div className="bg-orange-50 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-orange-600">Active Goals</p>
                <p className="text-2xl font-bold text-orange-900">{goals.length}</p>
              </div>
                          ...
                          {session.topics.length > 0 && (
                            <div className="flex flex-wrap gap-1 mt-2">
                              {session.topics.map((topic) => (
                                <span key={topic} className="px-2 py-1 text-xs bg-blue-100 text-blue-700 rounded-full">
                                  {topic}
                                </span>
                              ))}
                            </div>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                          ...
                          style={{ width: `${(goal.completedSessions / goal.totalSessions) * 100}%` }}
                        />
                      </div>
                    </div>
      ...
      {showAddSession && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Add Study Session</h2>
      ...
      {showAddGoal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Add Study Goal</h2>
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Title</label>
                <input
