...
function Settings({ user, onUpdateUser }) {
						...
						>
							<label className="toggle-switch">
								<input
									...
									onChange={(e) =>
										handleSettingChange("showAnimations", e.target.checked)
									}
								/>
								<span className="toggle-slider"></span>
							</label>
					...
					<div className="settings-section">
						...
						>
							<label className="toggle-switch">
								<input
									...
									onChange={(e) =>
										handleSettingChange("streakNotifications", e.target.checked)
									}
								/>
								<span className="toggle-slider"></span>
							</label>
						...
						>
							<input
								...
								onChange={(e) =>
									handleSettingChange("preferredStudyTime", e.target.value)
								}
								className="setting-input"
							/>
						</SettingItem>
						...
						>
							<label className="toggle-switch">
								<input
									...
									onChange={(e) =>
										handleSettingChange("showProfilePublic", e.target.checked)
									}
								/>
								<span className="toggle-slider"></span>
							</label>
						...
						>
							<label className="toggle-switch">
								<input
									...
									onChange={(e) =>
										handleSettingChange("showStatsPublic", e.target.checked)
									}
								/>
								<span className="toggle-slider"></span>
							</label>
	...
	return (
		<div className="settings">
			...
			{isDirty && (
				<div className="unsaved-changes-notice">⚠️ You have unsaved changes</div>
			)}
		</div>
	);
}
