...
import { premiumService, SubscriptionTier, UserSubscription } from '../lib/premium-features';
    ...
    <div className="max-w-7xl mx-auto p-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Status: {currentSubscription.status} • Expires: {currentSubscription.endDate.toLocaleDateString()}
              </p>
            </div>
            <div className="text-right">
              <div className="text-2xl font-bold text-blue-600 mb-1">
                {currentSubscription.status === 'trial' ? 'FREE TRIAL' : `$${subscriptionTiers.find(t => t.id === currentSubscription.tier)?.price[billingCycle] || 0}`}
              </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              ...
              <tr className="border-b border-gray-100">
                <td className="py-4 px-6 font-medium text-gray-900">Problems Access</td>
              ...
              {/* Analytics */}
              <tr className="border-b border-gray-100">
                <td className="py-4 px-6 font-medium text-gray-900">Analytics History</td>
                <td className="text-center py-4 px-6">
              ...
              {/* AI Recommendations */}
              <tr className="border-b border-gray-100">
                <td className="py-4 px-6 font-medium text-gray-900">AI Recommendations</td>
                <td className="text-center py-4 px-6">
              ...
              {/* Code Execution */}
              <tr className="border-b border-gray-100">
                <td className="py-4 px-6 font-medium text-gray-900">Code Execution</td>
                <td className="text-center py-4 px-6">
                  <span className="text-gray-600">100/month</span>
                </td>
                <td className="text-center py-4 px-6">
              ...
              {/* Mock Interviews */}
              <tr className="border-b border-gray-100">
                <td className="py-4 px-6 font-medium text-gray-900">Mock Interviews</td>
                <td className="text-center py-4 px-6">
              ...
              {/* Team Management */}
              <tr>
                <td className="py-4 px-6 font-medium text-gray-900">Team Management</td>
                <td className="text-center py-4 px-6">
                  <XMarkIcon className="h-5 w-5 text-gray-400 mx-auto" />
                </td>
                <td className="text-center py-4 px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <div className="text-center p-6">
          ...
          <p className="text-gray-600">
            Get detailed insights into your performance with trend analysis, predictions, and personalized recommendations.
          </p>
        </div>
        ...
        <div className="text-center p-6">
          ...
          <p className="text-gray-600">
            Leverage artificial intelligence for personalized problem recommendations and adaptive difficulty adjustment.
          </p>
        </div>
        ...
        <div className="text-center p-6">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Competitive Features</h3>
          <p className="text-gray-600">
            Join exclusive tournaments, access mock interviews, and compete with the best programmers worldwide.
          </p>
        </div>
      </div>
      ...
      <div className="bg-gray-50 rounded-xl p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Yes, we offer a 7-day free trial of Premium features. No credit card required.
            </p>
          </div>
...
function PricingCard({ tier, currentTier, onSelectTier, billingCycle }: PricingCardProps) {
    ...
    <div className={`relative bg-white rounded-2xl p-8 border-2 transition-all ${
      ...
      <div className="text-center mb-8">
        <div className="flex justify-center mb-4">
          {tier.id === 'free' && <StarIcon className="h-12 w-12 text-gray-500" />}
          {tier.id === 'premium' && <BoltIcon className="h-12 w-12 text-blue-500" />}
          {tier.id === 'pro' && <CrownIcon className="h-12 w-12 text-purple-500" />}
          {tier.id === 'enterprise' && <ShieldCheckIcon className="h-12 w-12 text-green-500" />}
        </div>
          ...
          {price === 0 ? (
            ...
            <>
              <div className="text-4xl font-bold text-gray-900">
                ${billingCycle === 'yearly' ? Math.round(monthlyEquivalent) : price}
              </div>
              <div className="text-sm text-gray-500">
                {billingCycle === 'yearly' ? (
