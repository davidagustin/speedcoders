...
export default function EnhancedDashboard() {
	...
	const [activeTab, setActiveTab] = useState<
		"overview" | "recommendations" | "activity" | "social"
	>("overview");
	...
	const fetchDashboardData = async () => {
		try {
			...
			const [analyticsRes, recommendationsRes, _progressRes] =
				await Promise.all([
			...
			if (analyticsRes.ok) {
				...
				setStats((prev) => ({
					...
					currentStreak:
						analytics.consistency?.streakAnalysis?.currentStreak || 0,
	...
	const generateRecommendationCards = (_data: any) => {
		...
		<div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-6">
			<div className="max-w-7xl mx-auto">
				...
				<div className="bg-white rounded-xl shadow-sm p-6 mb-8">
					<div className="flex items-center justify-between mb-4">
						...
						<span className="text-sm text-gray-600">
							{stats.weeklyProgress}/{stats.weeklyGoal} problems
						</span>
					</div>
					...
					<p className="text-sm text-gray-600 mt-2">
						{Math.max(0, stats.weeklyGoal - stats.weeklyProgress)} problems
				...
				<div className="min-h-96">
					{activeTab === "overview" && (
						<OverviewTab onQuickAction={handleQuickAction} />
					)}
				...
				<div className="space-y-3">
					...
					<div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
						<div>
							...
							<p className="text-sm text-gray-600">
								22 members • Study session in 2h
							</p>
						</div>
