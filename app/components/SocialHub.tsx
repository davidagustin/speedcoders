...
export default function SocialHub() {
    ...
    const mockPosts: Post[] = [
      {
        id: '1',
        author: mockUsers[0],
        content: 'Just solved the "Maximum Subarray" problem using Kadane\'s algorithm! The key insight is to keep track of the current sum and reset it when it becomes negative. Check out my solution below:',
        code: {
          language: 'javascript',
  ...
  return maxSum;
      ...
      },
      {
        id: '2',
        author: mockUsers[1],
        content: 'Finally reached level 18! 🎉 The grind is real but so worth it. Currently working through the graph problems - BFS and DFS are becoming second nature now.',
      ...
      },
      {
        id: '3',
        author: mockUsers[2],
        content: 'Pro tip for binary search: Always think about the invariant! What property remains true throughout your search? This mental model has helped me solve dozens of problems.',
    ...
    const mockGroups: StudyGroup[] = [
      {
        ...
        description: 'Deep dive into DP patterns and techniques. Weekly sessions covering classic problems.',
      ...
      },
      {
        ...
        description: 'Friendly group for newcomers. We solve Easy problems together and explain concepts.',
        members: [mockUsers[1]],
        maxMembers: 20,
        category: 'General',
        difficulty: 'Beginner',
      ...
      },
      {
        ...
        description: 'Exploring graph theory and algorithms. From basic traversals to advanced topics.',
        members: mockUsers,
        maxMembers: 12,
    ...
    const mockChallenges: Challenge[] = [
      {
        ...
        description: 'Solve 5 binary tree problems in the most efficient way possible. Focus on clean, readable code.',
      ...
      },
      {
        ...
        description: 'Race against time! Solve as many Easy problems as you can in 30 minutes.',
  ...
  const joinChallenge = (challengeId: string) => {
    setChallenges(prev => prev.map(challenge =>
      challenge.id === challengeId ? { ...challenge, isParticipating: !challenge.isParticipating } : challenge
    ));
  };
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">Connect with fellow coders and learn together</p>
      </div>
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-blue-600 text-sm">Level {post.author.level}</span>
                  </div>
                ...
                {post.code && (
                  <div className="bg-gray-900 rounded-lg p-4 mb-3">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-gray-400 text-sm">{post.code.language}</span>
                      <span className="text-gray-400 text-sm">{post.code.problem}</span>
                    </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {friends.map((friend) => (
                <div key={friend.id} className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    {friend.title && (
                      <div className="text-xs text-purple-600 mt-1">{friend.title}</div>
                    )}
                  </div>
                  <button
                ...
                <div className="flex justify-between items-center">
                  <div className="flex -space-x-2">
                    {group.members.slice(0, 3).map((member, index) => (
                      <div key={index} className="text-lg border-2 border-white rounded-full bg-gray-100">
                        {member.avatar}
                      </div>
                    ))}
            ...
            {challenges.map((challenge) => (
              <div key={challenge.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">{challenge.creator.username}</div>
                    <div className="text-sm text-gray-500">Challenge Creator</div>
                  </div>
                </div>
