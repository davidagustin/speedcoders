	...
	const AchievementCard = ({ achievement }) => {
		...
		return (
			<div className={`achievement-card ${earned ? "earned" : "locked"}`}>
				...
				{earned && <div className="achievement-date">Earned: Recently</div>}
			</div>
		);
	};
	...
	return (
		<div className="achievements">
				...
				<div className="overview-stats">
					<div className="overview-item">
						<span className="overview-number">
							{userAchievements.earned.length}
						</span>
						<span className="overview-label">Earned</span>
					</div>
					<div className="overview-item">
						<span className="overview-number">
							{userAchievements.allAchievements.length}
						</span>
						...
						>
							...
							{category.id !== "all" && categoryStats[category.id] && (
								<span className="tab-count">
									{categoryStats[category.id].earned}/
			...
			<div className="achievement-suggestions">
							...
							<div key={achievement.id} className="suggestion-card">
								...
								<div className="suggestion-info">
									...
									<div className="suggestion-progress">
										...
										<span>
											{achievement.requirement - achievement.current} more to
											go!
										</span>
									</div>
								</div>
				...
				{filteredAchievements.filter((a) => !a.earned && a.progress >= 50)
					.length === 0 && (
			...
			<div className="achievement-tips">
				...
				<div className="tips-grid">
					<div className="tip-card">
						...
						<p>
							Solve at least one problem daily to build streaks and earn
					...
					<div className="tip-card">
						...
						<p>
							Challenge yourself with Medium and Hard problems to unlock
					...
					<div className="tip-card">
						...
						<p>
							Practice diverse algorithm types to earn the Algorithm Enthusiast
							achievement.
						</p>
					</div>
					...
					<div className="tip-card">
						...
						<p>
							Aim for 100% accuracy on quizzes to earn performance-based
							achievements.
						</p>
					</div>
				</div>
