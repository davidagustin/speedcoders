...
export default function MasterDashboard() {
  ...
  const loadDashboardData = async () => {
    ...
    const mockStats: DashboardStats = {
      ...
      recentAchievements: [
        { name: 'Speed Demon', icon: '⚡', rarity: 'rare', earnedAt: '2 hours ago' },
        { name: 'Streak Master', icon: '🔥', rarity: 'epic', earnedAt: '1 day ago' },
        { name: 'Array Expert', icon: '📊', rarity: 'common', earnedAt: '3 days ago' }
      ],
      upcomingContests: [
        { name: 'Weekly Algorithm Sprint', date: '2024-01-22', participants: 1247 },
        { name: 'DP Masters Championship', date: '2024-01-28', participants: 856 },
        { name: 'Speed Coding Challenge', date: '2024-02-05', participants: 2341 }
      ],
      recommendedProblems: [
        { title: 'Maximum Subarray Sum', difficulty: 'Medium', category: 'Dynamic Programming', estimatedTime: 25 },
        { title: 'Valid Binary Search Tree', difficulty: 'Medium', category: 'Tree', estimatedTime: 20 },
        { title: 'Longest Palindromic Substring', difficulty: 'Medium', category: 'String', estimatedTime: 30 }
      ]
    };
  ...
  const navigation = [
    { id: 'overview', name: 'Overview', icon: ChartBarIcon, current: currentView === 'overview' },
    { id: 'practice', name: 'Practice', icon: PlayIcon, current: currentView === 'practice' },
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 text-white">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-blue-100 text-lg">Ready to solve some problems today?</p>
                </div>
                <div className="text-right">
                  <div className="text-blue-100">Level</div>
                  <div className="text-4xl font-bold">{dashboardStats.level}</div>
                ...
                <div className="mt-4">
                  <div className="bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{ width: `${(dashboardStats.totalSolved / dashboardStats.totalProblems) * 100}%` }}
                    />
                  </div>
                </div>
              </div>
                  ...
                  <div className="relative w-24 h-24 mx-auto mb-4">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="text-2xl font-bold text-gray-900">
                        {dashboardStats.todaysGoal.completed}/{dashboardStats.todaysGoal.target}
                      </span>
                    </div>
                  </div>
                  <p className="text-gray-600">
                    {dashboardStats.todaysGoal.target - dashboardStats.todaysGoal.completed} problems left
                  </p>
                  <button 
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-20 h-2 bg-gray-200 rounded-full">
                          <div
                            ...
                            style={{ width: `${Math.min(day.problems / 5 * 100, 100)}%` }}
                          />
                        </div>
                  ...
                  {dashboardStats.recentAchievements.map((achievement, index) => (
                    <div key={index} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-gray-500">{achievement.earnedAt}</div>
                      </div>
