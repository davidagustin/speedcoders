...
export default function QuizCreator({ onCreateQuiz, isLoading }: QuizCreatorProps) {
  ...
  const getEstimatedTime = () => {
    ...
    return Math.ceil((problemCount * timePerProblem[difficulty as keyof typeof timePerProblem]) / 60)
  }
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="mb-6 p-4 bg-blue-50 rounded-lg">
        <div className="flex items-center justify-between">
          ...
          <span className="text-lg font-semibold text-blue-700">{getEstimatedTime()} minutes</span>
        </div>
      </div>
