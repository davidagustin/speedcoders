		...
		<div className="space-y-6">
					...
					<div className="mt-2">
						<div className="w-full bg-gray-200 rounded-full h-2">
							<div
								...
								style={{
									width: `${(data.solvedProblems / data.totalProblems) * 100}%`,
								}}
							/>
						</div>
					</div>
			...
			<div className="bg-white rounded-lg shadow-sm border p-6">
				<div className="flex items-center justify-between mb-4">
					...
					<span
						className={`px-3 py-1 rounded-full text-sm font-medium ${getLevelColor(data.level)}`}
					>
						{data.level}
					</span>
				</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
					...
					<div className="text-center">
						...
						<p className="font-semibold text-gray-900">
							+{data.streakDays * 5} XP
						</p>
					</div>
					<div className="text-center">
						<p className="text-gray-600">Accuracy Bonus</p>
						<p className="font-semibold text-gray-900">
							+{Math.floor(data.accuracy / 10)} XP
						</p>
					</div>
				</div>
			</div>
