							...
							<div className="bg-white rounded-lg shadow-sm border p-4">
								...
								<div className="space-y-3 text-sm text-gray-600">
									<div className="p-3 bg-blue-50 rounded-lg">
										<strong>JavaScript:</strong> Use console.log() for output.
										The playground supports ES6+ features.
									</div>
									<div className="p-3 bg-green-50 rounded-lg">
										<strong>Python:</strong> Use print() for output. Basic
										Python syntax is supported.
									</div>
									<div className="p-3 bg-purple-50 rounded-lg">
										<strong>Other Languages:</strong> Code execution is
										simulated. Use proper IDEs for full functionality.
									</div>
									<div className="p-3 bg-yellow-50 rounded-lg">
										<strong>Safety:</strong> Code runs in a sandboxed
										environment. Be careful with infinite loops!
									</div>
								</div>
							</div>
						)}
