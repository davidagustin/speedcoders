      ...
      <div className="lg:pl-64">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="card p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-500 dark:text-slate-400">Problems Solved</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">{progressData.problemsSolved}</p>
                </div>
              </div>
            </div>
            ...
            <div className="card p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-500 dark:text-slate-400">Average Score</p>
            ...
            <div className="card p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-500 dark:text-slate-400">Current Streak</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">{progressData.currentStreak} days</p>
                </div>
              </div>
            </div>
            ...
            <div className="card p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-500 dark:text-slate-400">Time Spent</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">{formatTime(progressData.totalTimeSpent)}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            {/* Difficulty Progress */}
            <div className="card p-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Difficulty Progress</h3>
              <div className="space-y-4">
                {Object.entries(progressData.difficultyBreakdown).map(([difficulty, data]) => (
                  <div key={difficulty} className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <span className={`badge ${getDifficultyColor(difficulty.charAt(0).toUpperCase() + difficulty.slice(1))}`}>
              ...
              <div className="space-y-3">
                {progressData.categoryProgress.slice(0, 6).map((category) => (
                  <div key={category.category} className="flex items-center justify-between">
                    <span className="text-sm text-gray-600 dark:text-slate-300">{category.category}</span>
                    <div className="flex items-center gap-2">
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
                  ...
                  <tbody className="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-700">
                    {progressData.recentActivity.map((activity) => (
                      <tr key={activity.id} className="hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
