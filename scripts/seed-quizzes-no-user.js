...
const quizzes = [
  {
    ...
    description: "Master the basics of array manipulation with these essential problems.",
    timeLimit: 30,
    difficulty: "Easy",
    category: "Array",
    questions: [
  ...
  },
  {
    ...
    description: "Tackle more complex array problems requiring advanced techniques.",
    timeLimit: 45,
    difficulty: "Medium",
    category: "Array",
    questions: [
  ...
  },
  {
    ...
    description: "Master different tree traversal techniques and tree-based algorithms.",
    timeLimit: 50,
    difficulty: "Mixed",
    category: "Tree",
    questions: [
  ...
  },
  {
    ...
    description: "Master the two pointers technique for efficient array and string problems.",
    timeLimit: 40,
    difficulty: "Medium",
  ...
  },
  {
    ...
    description: "Advanced sliding window problems for string and array manipulation.",
    timeLimit: 60,
    difficulty: "Hard",
  ...
  },
  {
    ...
    description: "A collection of easy problems across different categories to build confidence.",
    timeLimit: 45,
    difficulty: "Easy",
    category: "Mixed",
    questions: [
  ...
  },
  {
    ...
    description: "Medium difficulty problems covering various algorithms and data structures.",
    timeLimit: 90,
    difficulty: "Medium",
    category: "Mixed",
    questions: [
  ...
  },
  {
    ...
    description: "A comprehensive quiz covering common interview problems across all difficulty levels.",
    timeLimit: 120,
    difficulty: "Mixed",
    category: "Interview",
    questions: [
...
async function seedQuizzes() {
  ...
  try {
    // Get or create a default user for creating quizzes
    let defaultUserId;
    ...
    if (users.length === 0) {
      ...
      console.log('✅ Using existing user for quiz creation');
    }
    ...
    quizzesWithQuestions.forEach(quiz => {
      ...
      quiz.questions.forEach(q => {
        console.log(`  ${q.order}. ${q.problem.title} (${q.problem.difficulty})`);
      });
    });
