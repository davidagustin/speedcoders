...
const questions = [
  // Array Problems
  {
    ...
    solutions: JSON.stringify([
      {
        name: "Hash Map",
        approach: "Use a hash map to store complements. For each number, check if its complement exists in the map.",
        timeComplexity: "O(n)",
        spaceComplexity: "O(n)"
      },
      {
  ...
  },
  {
    ...
    solutions: JSON.stringify([
      {
        name: "One Pass",
        approach: "Keep track of minimum price and maximum profit in a single pass.",
        timeComplexity: "O(n)",
        spaceComplexity: "O(1)"
      }
    ]),
  ...
  },
  {
    ...
    solutions: JSON.stringify([
      {
        name: "Two Pass",
        approach: "Calculate left products, then right products in separate passes.",
        timeComplexity: "O(n)",
        spaceComplexity: "O(1)"
      }
    ]),
  ...
  // Linked List Problems
  {
    ...
    solutions: JSON.stringify([
      ...
      {
        name: "Recursive",
        approach: "Recursively reverse the rest of the list and update pointers.",
        timeComplexity: "O(n)",
        spaceComplexity: "O(n)"
      }
    ]),
  ...
  // Two Pointers Problems
  {
    ...
    description: "Given n non-negative integers height where each represents a point at coordinate (i, height[i]), find two lines, which, together with the x-axis forms a container, such that the container contains the most water. Return the maximum amount of water a container can store.",
    examples: JSON.stringify([
      {
    ...
    solutions: JSON.stringify([
      {
        name: "Two Pointers",
        approach: "Use two pointers from both ends, move the shorter one inward.",
        timeComplexity: "O(n)",
        spaceComplexity: "O(1)"
      }
    ]),
  ...
  // Sliding Window Problems
  {
    ...
    solutions: JSON.stringify([
      {
        name: "Sliding Window",
        approach: "Use two pointers to maintain a window with all required characters.",
        timeComplexity: "O(m+n)",
        spaceComplexity: "O(k)"
      }
    ]),
...
async function seedQuestions() {
  ...
  try {
    for (const question of questions) {
      ...
      console.log(`✅ Created: "${createdQuestion.title}" (${createdQuestion.difficulty})`);
    }
