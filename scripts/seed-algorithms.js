...
const algorithms = [
    ...
    examples: JSON.stringify([
      {
        input: "[10, 7, 8, 9, 1, 5]",
        output: "[1, 5, 7, 8, 9, 10]",
        explanation: "Choose pivot, partition around it, recursively sort subarrays."
      }
    ])
  },
  {
    ...
    examples: JSON.stringify([
      {
        ...
        explanation: "Divide into halves, recursively sort, merge sorted halves."
      }
    ])
  },
    ...
    examples: JSON.stringify([
      {
        ...
        output: "Index: 3",
        explanation: "Compare with middle element, eliminate half of remaining elements."
      }
    ])
  },
  {
    ...
    examples: JSON.stringify([
      {
        ...
        explanation: "Explore all neighbors at current level before going deeper."
      }
    ])
  },
    ...
    examples: JSON.stringify([
      {
        input: "n = 10",
        output: "55",
        explanation: "Store previously calculated Fibonacci numbers to avoid recalculation."
      }
    ])
  },
  {
    ...
    category: "Dynamic Programming",
    description: "A classic dynamic programming problem to find the longest subsequence present in both strings in the same order.",
  ...
  // Tree Algorithms
  {
    ...
    category: "Tree",
    description: "A tree traversal method that visits the left subtree, then the root, then the right subtree.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(h)",
    examples: JSON.stringify([
      {
  ...
  },
  {
    ...
    category: "Tree",
    description: "A tree traversal method that visits all nodes at the current depth before moving to nodes at the next depth level.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(w)",
    examples: JSON.stringify([
      {
  ...
  // String Algorithms
  {
    name: "KMP Algorithm",
    category: "String",
    description: "A string matching algorithm that uses information about the pattern to skip unnecessary comparisons.",
    timeComplexity: "O(m+n)",
    spaceComplexity: "O(m)",
    examples: JSON.stringify([
      {
  ...
  },
  {
    ...
    category: "String",
    description: "A string searching algorithm that uses hashing to find patterns in text.",
  ...
  // Array Algorithms
  {
    ...
    category: "Array",
    description: "An algorithm to find the maximum sum of a contiguous subarray in an array of numbers.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    examples: JSON.stringify([
      {
  ...
  },
  {
    ...
    category: "Array",
    description: "A technique that uses two pointers to solve problems involving arrays, often for searching pairs or subarrays.",
    timeComplexity: "O(n)",
    spaceComplexity: "O(1)",
    examples: JSON.stringify([
      {
...
async function seedAlgorithms() {
  ...
  try {
    for (const algorithm of algorithms) {
      ...
      console.log(`✅ Created: "${createdAlgorithm.name}" (${createdAlgorithm.category})`);
    }
